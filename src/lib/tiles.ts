...
export const MAHJONG_TILES: TileDef[] = [
  ...
  // Dots (Tong)
  { id: 'd1', suit: 'Dots', value: 1, name: 'One Dot', unicode: '🀙', image: getImageUrl('d1') },
  { id: 'd2', suit: 'Dots', value: 2, name: 'Two Dot', unicode: '🀚', image: getImageUrl('d2') },
  { id: 'd3', suit: 'Dots', value: 3, name: 'Three Dot', unicode: '🀛', image: getImageUrl('d3') },
  { id: 'd4', suit: 'Dots', value: 4, name: 'Four Dot', unicode: '🀜', image: getImageUrl('d4') },
  { id: 'd5', suit: 'Dots', value: 5, name: 'Five Dot', unicode: '🀝', image: getImageUrl('d5') },
  { id: 'd6', suit: 'Dots', value: 6, name: 'Six Dot', unicode: '🀞', image: getImageUrl('d6') },
  { id: 'd7', suit: 'Dots', value: 7, name: 'Seven Dot', unicode: '🀟', image: getImageUrl('d7') },
  { id: 'd8', suit: 'Dots', value: 8, name: 'Eight Dot', unicode: '🀠', image: getImageUrl('d8') },
  { id: 'd9', suit: 'Dots', value: 9, name: 'Nine Dot', unicode: '🀡', image: getImageUrl('d9') },
  // Bamboo (Tiao)
  ...
  { id: 'h1', suit: 'Honors', value: 'E', name: 'East Wind', unicode: '🀀', image: getImageUrl('h1') },
  { id: 'h2', suit: 'Honors', value: 'S', name: 'South Wind', unicode: '🀁', image: getImageUrl('h2') },
  { id: 'h3', suit: 'Honors', value: 'W', name: 'West Wind', unicode: '🀂', image: getImageUrl('h3') },
  { id: 'h4', suit: 'Honors', value: 'N', name: 'North Wind', unicode: '🀃', image: getImageUrl('h4') },
  { id: 'h5', suit: 'Honors', value: 'WHT', name: 'White Dragon', unicode: '🀆', image: getImageUrl('h5') },
  { id: 'h6', suit: 'Honors', value: 'GRN', name: 'Green Dragon', unicode: '🀅', image: getImageUrl('h6') },
  { id: 'h7', suit: 'Honors', value: 'RED', name: 'Red Dragon', unicode: '🀄', image: getImageUrl('h7') },
  // Flowers (1-4)
