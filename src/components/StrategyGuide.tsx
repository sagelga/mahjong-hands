...
const HAND_TYPES = [
  {
    ...
    role: 'Pair set',
    desc: 'Two identical tiles. Every winning hand needs exactly one pair — called the "eyes." Pairs cannot form a set; they exist alongside the four triplet/quadruplet sets.',
    rules: [
...
const STRICT_RULES = [
  ...
  },
  {
    ...
    body: 'A winning hand is exactly 14 tiles: 4 triplets + 1 pair = 14. Kongs don\'t break this because the extra draw compensates for the 4th tile and counts as one triplet for winning.',
  },
  {
    icon: '🌸',
    severity: 'warning',
...
function HandTypesSection() {
  return (
    <div className="strategy-section">
      <SectionHeader icon="🀄" title="The Four Hand Types" />
...
function StrictRulesSection() {
  return (
    <div className="strategy-section">
      <SectionHeader icon="⚠️" title="Strict Rules — Don't Get Penalized" />
      <p style={{ marginBottom: '1.25rem', color: 'var(--text-secondary)', fontSize: '0.9rem' }}>
  ...
  return (
    <PageContent className="strategy-container">
      ...
      <PageHeader 
        ...
        subtitle="From beginner principles to advanced wait reading — level up your game."
      />
