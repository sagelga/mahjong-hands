...
const CookieSettingsModal: React.FC<CookieSettingsModalProps> = ({ isOpen, onClose, onSave }) => {
  ...
  useEffect(() => {
    ...
    setPreferences({ functional: current.functional, analytics: current.analytics });
  }, []);

  const handleSave = () => {
    setCookiePreferences({ ...preferences, consentGiven: true, consentTimestamp: Date.now() });
    onSave();
    onClose();
  };
    ...
    <BottomSheet isOpen={isOpen} onClose={onClose} title="Cookie Settings">
      <div className="cookie-settings-list">
        <div className="cookie-category">
          <div className="cookie-category-header">
            ...
            <div className="cookie-category-toggle disabled" aria-hidden="true">
              <div className="toggle-track toggle-on"><div className="toggle-thumb" /></div>
            </div>
          </div>
          <p className="cookie-category-description">Essential for the website to function. These cannot be disabled.</p>
        </div>
        ...
        <div className="cookie-category">
          <div className="cookie-category-header">
            ...
            >
              <div className={`toggle-track${preferences.analytics ? ' toggle-on' : ''}`}>
                <div className="toggle-thumb" />
              </div>
            </button>
          </div>
          <p className="cookie-category-description">Help us understand how visitors use the site. All data is anonymous.</p>
        </div>
      </div>
      ...
      <div className="cookie-settings-footer">
        <p className="cookie-learn-more">
          Learn more in our{' '}
          <a href="https://sagelga.com/privacy-policy" className="cookie-learn-more-link" target="_blank" rel="noopener noreferrer">
            Privacy Policy
          </a>.
        </p>
      </div>
      ...
      <div className="cookie-settings-actions">
        <button onClick={handleSave} className="cookie-save-btn">Save preferences</button>
      </div>
    </BottomSheet>
  );
};
